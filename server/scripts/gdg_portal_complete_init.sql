...
-- 插入管理員帳號 (Google OAuth 使用者)
INSERT INTO users (google_id, email, name, avatar_url, role, is_active, email_verified, created_at, updated_at) VALUES
('123456789012345678901', 'admin@gdg.nknu.edu.tw', 'GDG NKNU Admin', '/assets/users/admin_avatar.jpg', 'admin', true, true, NOW(), NOW());

-- 插入測試用傳統帳號 (有密碼)
-- 密碼: testpassword123 (建議實際使用時更改)
INSERT INTO users (email, password, name, role, is_active, email_verified, created_at, updated_at) VALUES
('test@gdg.nknu.edu.tw', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj/hS3Kw3uIy', 'Test User', 'member', true, false, NOW(), NOW());
...
('tech', 'member', '#4F46E5', true, NOW());

INSERT INTO categories (name, type, color, is_active, created_at) VALUES
('pr', 'member', '#059669', true, NOW());

INSERT INTO categories (name, type, color, is_active, created_at) VALUES
('core', 'member', '#DC2626', true, NOW());

INSERT INTO categories (name, type, color, is_active, created_at) VALUES
('design', 'member', '#7C3AED', true, NOW());

INSERT INTO categories (name, type, color, is_active, created_at) VALUES
('affairs', 'member', '#EA580C', true, NOW());
