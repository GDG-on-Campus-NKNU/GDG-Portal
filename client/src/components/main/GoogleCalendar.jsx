export function GoogleCalendar() {
  return (
    <section className="relative bg-white/70 backdrop-blur-xl border border-white/20 rounded-3xl p-6 shadow-xl hover:shadow-2xl transform hover:scale-[1.01] transition-all duration-300 overflow-hidden">
      {/* 背景裝飾 */}
      ...
      <div className="relative z-10">
        ...
        <div className="relative h-80 lg:h-96 min-w-0">
          <div className="absolute inset-0 bg-gradient-to-r from-blue-400/10 to-green-400/10 rounded-2xl blur opacity-50"></div>
          <iframe
